"""
Django settings for winter_disk_dev_96989 project.
...
ROOT_URLCONF = 'winter_disk_dev_96989.urls'
...
WSGI_APPLICATION = 'winter_disk_dev_96989.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "winter_disk_dev_96989 API",
    "DESCRIPTION": "API documentation for winter_disk_dev_96989 App",
    "VERSION": "v1",
}
